        ...
        <div className='grid md:grid-cols-2'>
            <div className='flex justify-evenly w-full md:max-w-[300px] uppercase'>
                <div>
                    ...
                    <ul>
                        <li className='text-sm py-2 cursor-pointer'>Donnez-nous votre avis</li>
                        <li className='text-sm py-2 cursor-pointer'>Centre d'assistance</li>
                        <li className='text-sm py-2 cursor-pointer'>Envoyer une demande</li>
                        <li className='text-sm py-2 cursor-pointer'>Vérification Bitmonnaie</li>
                    </ul>
                </div>
                <div>
            ...
            <div className='text-right'>
                <div className='w-full flex justify-end'>
                    <div className='w-full md:w-[300px] py-4 relative'>
                        ...
                        <p className='text-center md:text-right cursor-pointer'>S'abonner à nos infos</p>
                        <div className='py-4'>
                            <form className='flex'>
                                <input 
                                ...
                                />
                                <button className='bg-button text-btnText px-4 p-2 w-full rounded-2xl shadow-xl hover:shadow-2xl md:w-auto my-2'>S'inscrire</button>
                            </form>
                        </div>
